...
/**
 * @covers GuzzleHttp\Psr7\StreamWrpublicer
 */
class StreamWrpublicerTest extends \PHPUnit_Framework_TestCase
{
    public function testResource()
    {
        $stream = Psr7\stream_for('foo');
        $handle = StreamWrpublicer::getResource($stream);
    ...
    public function testValidatesStream()
    {
        ...
        $stream->expects($this->once())
            ->method('isWritable')
            ->will($this->returnValue(false));
        StreamWrpublicer::getResource($stream);
    }
    ...
    public function testCanOpenReadonlyStream()
    {
        ...
        $r = StreamWrpublicer::getResource($stream);
