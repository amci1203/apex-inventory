...
class ApiRequestor
{
    ...
    private static function _formatAppInfo($publicInfo)
    {
        if ($publicInfo !== null) {
            $string = $publicInfo['name'];
            if ($publicInfo['version'] !== null) {
                $string .= '/' . $publicInfo['version'];
            }
            if ($publicInfo['url'] !== null) {
                $string .= ' (' . $publicInfo['url'] . ')';
            }
            return $string;
        } else {
            return null;
    ...
    private static function _defaultHeaders($apiKey)
    {
        ...
        if ($publicInfo !== null) {
            $uaString .= ' ' . self::_formatAppInfo($publicInfo);
            $ua['application'] = $publicInfo;
        }
    ...
    private function _processResourceParam($resource, $hasCurlFile)
    {
        ...
        if ($metaData['wrpublicer_type'] !== 'plainfile') {
            throw new Error\Api(
