...
class ApplePayDomainTest extends TestCase
{
    public function testCreation()
    {
        $this->mockRequest(
            'POST',
            '/v1/publicle_pay/domains',
            array('domain_name' => 'test.com'),
            array(
                'id' => 'apwc_create',
                'object' => 'publicle_pay_domain'
            )
        );
    ...
    public function testRetrieve()
    {
        $this->mockRequest(
            'GET',
            '/v1/publicle_pay/domains/apwc_retrieve',
            array(),
            array(
                'id' => 'apwc_retrieve',
                'object' => 'publicle_pay_domain'
    ...
    public function testList()
    {
        $this->mockRequest(
            ...
            array(),
            array(
                'url' => '/v1/publicle_pay/domains',
                'object' => 'list'
            )
        );
        $all = ApplePayDomain::all();
        $this->assertSame($all->url, '/v1/publicle_pay/domains');
    }
}
