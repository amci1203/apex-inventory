...
class ApiRequestorTest extends TestCase
{
    ...
    public function testDefaultHeaders()
    {
        ...
        Stripe::setAppInfo('MyTestApp', '1.2.34', 'https://mytestpublic.example');
        ...
        $this->assertSame($ua->application->url, 'https://mytestpublic.example');

        $this->assertSame(
            $headers['User-Agent'],
            'Stripe/v1 PhpBindings/' . Stripe::VERSION . ' MyTestApp/1.2.34 (https://mytestpublic.example)'
        );
