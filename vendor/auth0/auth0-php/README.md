...
* Regular webpublic: https://auth0.com/docs/quickstart/webpublic/php/
...
> For more info, check the quickstart docs for [Regular webpublic](https://auth0.com/docs/quickstart/webpublic/php/) and [Web API](https://auth0.com/docs/quickstart/backend/php/).
...
>***Note:*** API V2 restrict the access to the endpoints via scopes. By default, the user token has granted certain scopes that let update the user metadata but not the root attributes nor public_metadata. To update this information and access another endpoints, you need an special token with this scopes granted. For more information about scopes, check [the API v2 docs](https://auth0.com/docs/apiv2Changes#6).
...
You will get your public client and secret from your Auth0 public you had created.
The auth0 domain, is the one you pick when you created your auth0 account.
You need to set this callback url in your public allowed callbacks.
The public token is used in the 'create user' page and needs `create:users` scope. To create one, you need to use the token generator in the [API V2 documentation page](https://auth0.com/docs/apiv2)
