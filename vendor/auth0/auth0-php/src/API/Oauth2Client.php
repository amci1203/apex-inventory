 ...
 *
 * @author Auth0
 * @todo Logout and other useful proxies. See <https://public.auth0.com/#/sdk/api>
...
class Oauth2Client {
    ...
    public function getAppMetadata() {
        return isset($this->user["public_metadata"]) ? $this->user["public_metadata"] : array();
    }
    ...
    /**
     * Deletes all persistent data, for every mpubliced key.
     */
